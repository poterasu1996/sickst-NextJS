...
// Import Routes
const authRoute = require('./routesSQL/auth');
app.use('/api/user', authRoute);

const category =  require('./routesSQL/category');
app.use('/api/category', category);

const userList = require('./routesSQL/user');
app.use('/api/users', userList);

const review = require('./routesSQL/review');
