        ...
        <div className="container">
            <div className="row">
                <div className="col-12 col-md-6 left-side">
                    ...
                    {auth
                        ? <Button href="/subscription" className="button-primary big mt-5">Colectii</Button>
                        : <Button href="/account/register" className="button-primary big mt-5">Autentificare</Button>
                    }
